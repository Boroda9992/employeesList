...
//        addEmployee("Ivan", "Petrov41", 500000, 4);
    ...
    public Employee addEmployee(String firstName, String lastName, int salary, int department) throws EmployeeAlreadyAddedException, EmployeeStorageIsFullException{
        ...
        if (employeeMap.containsKey(employeeToAdd.getFIRST_NAME()) && employeeMap.containsKey(employeeToAdd.getLAST_NAME())) {
    ...
    @Override
    public Employee deleteEmployee(String firstName, String lastName, int salary, int department) throws EmployeeNotFoundException{
    ...
    @Override
    public Employee findEmployee(String firstName, String lastName, int salary, int department) throws EmployeeNotFoundException{
